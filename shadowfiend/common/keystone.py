...
from shadowfiend.common.i18n import _
from shadowfiend.common.i18n import _LE
from shadowfiend.common.i18n import _LW
...
class KeystoneClientV3(object):
    ...
    def get_validate_region_name(self, region_name):
        if region_name is None:
            message = _("region_name needs to be configured "
                        "in shadowfiend.conf")
