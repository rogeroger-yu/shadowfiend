...
class Version(object):
    ...
    string = 'X-OpenStack-Shadowfiend-API-Version'
    """HTTP Header string carrying the requested version"""

    min_string = 'X-OpenStack-Shadowfiend-API-Minimum-Version'
    """HTTP response header"""

    max_string = 'X-OpenStack-Shadowfiend-API-Maximum-Version'
    """HTTP response header"""
