...
from shadowfiend.api.controllers import versions
...
class Root(base.APIBase):
    ...
    def convert():
        root = Root()
        root.name = "OpenStack shadowfiend API"
        root.description = ("shadowfiend is an OpenStack project which aims to"
...
class RootController(rest.RestController):
    ...
    def _route(self, args):
        ...
        It redirects the request to the default version of the shadowfiend API
